...
export const demoLineasProducto = [
  {
    ...
    tendencia: 'up',
    margen: 22,
    proveedorPrincipal: 'Grupo Bimbo / Nestlé Guatemala',
    tiempoEntregaDias: 5,
  },
  {
    id: 'BEBI-001',
    ...
    tendencia: 'up',
    margen: 28,
    proveedorPrincipal: 'Coca-Cola FEMSA Guatemala',
    tiempoEntregaDias: 3,
  },
  {
    id: 'LIMP-001',
    ...
    tendencia: 'up',
    margen: 32,
    proveedorPrincipal: 'Unilever Centroamérica',
    tiempoEntregaDias: 7,
  },
  {
    id: 'CUID-001',
  ...
  },
  {
    ...
    tendencia: 'up',
    margen: 25,
    proveedorPrincipal: 'Kimberly-Clark México',
    tiempoEntregaDias: 4,
  },
  {
    id: 'MASC-001',
    ...
    tendencia: 'up',
    margen: 38,
    proveedorPrincipal: 'Nestlé Purina Guatemala',
    tiempoEntregaDias: 6,
  },
];
...
export const demoProductosStock = [
  // Alimentos
  { id: 1, nombre: 'Arroz 5lb (Saco)', linea: 'Alimentos', stock: 1850, stockMin: 800, stockMax: 2500, costoUnitario: 28, ventaPromedioMensual: 920, tendencia: 'up', proveedor: 'Grupo Bimbo Guatemala', diasEntrega: 5 },
  { id: 2, nombre: 'Frijol Negro 1kg', linea: 'Alimentos', stock: 1200, stockMin: 600, stockMax: 1800, costoUnitario: 18, ventaPromedioMensual: 580, tendencia: 'stable', proveedor: 'Grupo Bimbo Guatemala', diasEntrega: 5 },
  { id: 3, nombre: 'Azúcar Morena 2kg', linea: 'Alimentos', stock: 950, stockMin: 500, stockMax: 1500, costoUnitario: 22, ventaPromedioMensual: 420, tendencia: 'up', proveedor: 'Nestlé Guatemala', diasEntrega: 5 },
  { id: 4, nombre: 'Aceite Vegetal 1L (12 unds)', linea: 'Alimentos', stock: 680, stockMin: 400, stockMax: 1200, costoUnitario: 85, ventaPromedioMensual: 310, tendencia: 'up', proveedor: 'Unilever Centroamérica', diasEntrega: 5 },
  { id: 5, nombre: 'Leche Entera 1L (24 unds)', linea: 'Alimentos', stock: 420, stockMin: 300, stockMax: 800, costoUnitario: 65, ventaPromedioMensual: 280, tendencia: 'stable', proveedor: 'Nestlé Guatemala', diasEntrega: 3 },
  { id: 6, nombre: 'Café Instantáneo 100g', linea: 'Alimentos', stock: 580, stockMin: 350, stockMax: 900, costoUnitario: 45, ventaPromedioMensual: 240, tendencia: 'up', proveedor: 'Nestlé Guatemala', diasEntrega: 5 },
  { id: 7, nombre: 'Harina de Trigo 1kg', linea: 'Alimentos', stock: 720, stockMin: 400, stockMax: 1100, costoUnitario: 15, ventaPromedioMensual: 380, tendencia: 'stable', proveedor: 'Grupo Bimbo Guatemala', diasEntrega: 5 },
  { id: 8, nombre: 'Pasta Dental Colgate 75ml', linea: 'Cuidado Personal', stock: 850, stockMin: 400, stockMax: 1200, costoUnitario: 32, ventaPromedioMensual: 420, tendencia: 'up', proveedor: 'Colgate-Palmolive CA', diasEntrega: 5 },
  // Bebidas
  { id: 9, nombre: 'Coca-Cola 2L (8 unds)', linea: 'Bebidas', stock: 680, stockMin: 400, stockMax: 1000, costoUnitario: 45, ventaPromedioMensual: 380, tendencia: 'up', proveedor: 'Coca-Cola FEMSA', diasEntrega: 3 },
  { id: 10, nombre: 'Pepsi 2L (8 unds)', linea: 'Bebidas', stock: 520, stockMin: 300, stockMax: 800, costoUnitario: 42, ventaPromedioMensual: 290, tendencia: 'stable', proveedor: 'PepsiCo Guatemala', diasEntrega: 3 },
  { id: 11, nombre: 'Jugo Del Valle 1.5L (6 unds)', linea: 'Bebidas', stock: 420, stockMin: 250, stockMax: 700, costoUnitario: 38, ventaPromedioMensual: 220, tendencia: 'up', proveedor: 'Coca-Cola FEMSA', diasEntrega: 3 },
  { id: 12, nombre: 'Cerveza Gallo 350ml (24 unds)', linea: 'Bebidas', stock: 380, stockMin: 200, stockMax: 600, costoUnitario: 185, ventaPromedioMensual: 150, tendencia: 'stable', proveedor: 'Cervecería Centroamericana', diasEntrega: 4 },
  { id: 13, nombre: 'Agua Pura 1L (24 unds)', linea: 'Bebidas', stock: 1200, stockMin: 600, stockMax: 1800, costoUnitario: 12, ventaPromedioMensual: 680, tendencia: 'up', proveedor: 'Coca-Cola FEMSA', diasEntrega: 3 },
  { id: 14, nombre: 'Red Bull 250ml (24 unds)', linea: 'Bebidas', stock: 180, stockMin: 120, stockMax: 400, costoUnitario: 95, ventaPromedioMensual: 95, tendencia: 'up', proveedor: 'Red Bull Guatemala', diasEntrega: 7 },
  { id: 15, nombre: 'Gatorade 500ml (24 unds)', linea: 'Bebidas', stock: 320, stockMin: 200, stockMax: 500, costoUnitario: 28, ventaPromedioMensual: 175, tendencia: 'stable', proveedor: 'PepsiCo Guatemala', diasEntrega: 3 },
  { id: 16, nombre: 'Jugo Néctar 200ml (24 unds)', linea: 'Bebidas', stock: 280, stockMin: 180, stockMax: 450, costoUnitario: 22, ventaPromedioMensual: 145, tendencia: 'up', proveedor: 'PepsiCo Guatemala', diasEntrega: 3 },
  // Limpieza
  { id: 17, nombre: 'Detergente Líquido 3L', linea: 'Limpieza', stock: 650, stockMin: 350, stockMax: 1000, costoUnitario: 58, ventaPromedioMensual: 280, tendencia: 'up', proveedor: 'Unilever Centroamérica', diasEntrega: 7 },
  { id: 18, nombre: 'Cloro 4L', linea: 'Limpieza', stock: 820, stockMin: 400, stockMax: 1200, costoUnitario: 28, ventaPromedioMensual: 380, tendencia: 'stable', proveedor: 'Unilever Centroamérica', diasEntrega: 7 },
  { id: 19, nombre: 'Suavizante 3L', linea: 'Limpieza', stock: 580, stockMin: 300, stockMax: 900, costoUnitario: 65, ventaPromedioMensual: 240, tendencia: 'up', proveedor: 'Colgate-Palmolive CA', diasEntrega: 5 },
  { id: 20, nombre: 'Jabón en Polvo 2kg', linea: 'Limpieza', stock: 720, stockMin: 400, stockMax: 1100, costoUnitario: 45, ventaPromedioMensual: 320, tendencia: 'stable', proveedor: 'P&G Guatemala', diasEntrega: 5 },
  { id: 21, nombre: 'Desinfectante Multiusos 1L', linea: 'Limpieza', stock: 480, stockMin: 250, stockMax: 800, costoUnitario: 35, ventaPromedioMensual: 210, tendencia: 'up', proveedor: 'Unilever Centroamérica', diasEntrega: 7 },
  { id: 22, nombre: 'Lavalozas 500ml', linea: 'Limpieza', stock: 620, stockMin: 350, stockMax: 950, costoUnitario: 28, ventaPromedioMensual: 290, tendencia: 'stable', proveedor: 'Unilever Centroamérica', diasEntrega: 7 },
  { id: 23, nombre: 'Esponja Multiusos (24 unds)', linea: 'Limpieza', stock: 380, stockMin: 200, stockMax: 600, costoUnitario: 18, ventaPromedioMensual: 165, tendencia: 'stable', proveedor: 'Scotch-Brite CA', diasEntrega: 5 },
  { id: 24, nombre: 'Papel Toalla 3 rollos', linea: 'Limpieza', stock: 450, stockMin: 250, stockMax: 700, costoUnitario: 38, ventaPromedioMensual: 195, tendencia: 'up', proveedor: 'Kimberly-Clark México', diasEntrega: 4 },
  // Cuidado Personal
  { id: 25, nombre: 'Shampoo Head & Shoulders 400ml', linea: 'Cuidado Personal', stock: 520, stockMin: 280, stockMax: 800, costoUnitario: 72, ventaPromedioMensual: 240, tendencia: 'up', proveedor: 'P&G Guatemala', diasEntrega: 5 },
  { id: 26, nombre: 'Jabón de Baño 120g (6 unds)', linea: 'Cuidado Personal', stock: 780, stockMin: 400, stockMax: 1200, costoUnitario: 45, ventaPromedioMensual: 380, tendencia: 'stable', proveedor: 'Unilever Centroamérica', diasEntrega: 7 },
  { id: 27, nombre: 'Desodorante Axe 150ml', linea: 'Cuidado Personal', stock: 420, stockMin: 220, stockMax: 650, costoUnitario: 58, ventaPromedioMensual: 195, tendencia: 'up', proveedor: 'Unilever Centroamérica', diasEntrega: 7 },
  { id: 28, nombre: 'Crema Dental 90g', linea: 'Cuidado Personal', stock: 680, stockMin: 350, stockMax: 1000, costoUnitario: 38, ventaPromedioMensual: 310, tendencia: 'stable', proveedor: 'Colgate-Palmolive CA', diasEntrega: 5 },
  { id: 29, nombre: 'Acondicionador 400ml', linea: 'Cuidado Personal', stock: 380, stockMin: 200, stockMax: 600, costoUnitario: 68, ventaPromedioMensual: 175, tendencia: 'up', proveedor: 'P&G Guatemala', diasEntrega: 5 },
  { id: 30, nombre: 'Jabón Líquido 250ml', linea: 'Cuidado Personal', stock: 520, stockMin: 280, stockMax: 800, costoUnitario: 42, ventaPromedioMensual: 250, tendencia: 'stable', proveedor: 'Unilever Centroamérica', diasEntrega: 7 },
  { id: 31, nombre: 'Desodorante Dove 50ml', linea: 'Cuidado Personal', stock: 450, stockMin: 250, stockMax: 700, costoUnitario: 52, ventaPromedioMensual: 210, tendencia: 'up', proveedor: 'Unilever Centroamérica', diasEntrega: 7 },
  { id: 32, nombre: 'Crema Hidratante 200ml', linea: 'Cuidado Personal', stock: 320, stockMin: 180, stockMax: 500, costoUnitario: 85, ventaPromedioMensual: 145, tendencia: 'stable', proveedor: 'P&G Guatemala', diasEntrega: 5 },
  // Hogar
  { id: 33, nombre: 'Papel Higiénico 12 rollos', linea: 'Hogar', stock: 920, stockMin: 500, stockMax: 1500, costoUnitario: 65, ventaPromedioMensual: 420, tendencia: 'up', proveedor: 'Kimberly-Clark México', diasEntrega: 4 },
  { id: 34, nombre: 'Servilletas 200 unds', linea: 'Hogar', stock: 680, stockMin: 350, stockMax: 1000, costoUnitario: 32, ventaPromedioMensual: 310, tendencia: 'stable', proveedor: 'Kimberly-Clark México', diasEntrega: 4 },
  { id: 35, nombre: 'Papel Aluminio 7.6m', linea: 'Hogar', stock: 420, stockMin: 220, stockMax: 650, costoUnitario: 42, ventaPromedioMensual: 185, tendencia: 'stable', proveedor: 'Reynolds Wrap CA', diasEntrega: 5 },
  { id: 36, nombre: 'Bolsas Ziploc (50 unds)', linea: 'Hogar', stock: 380, stockMin: 200, stockMax: 600, costoUnitario: 55, ventaPromedioMensual: 165, tendencia: 'up', proveedor: 'SC Johnson CA', diasEntrega: 5 },
  { id: 37, nombre: 'Velas Blanca (12 unds)', linea: 'Hogar', stock: 520, stockMin: 250, stockMax: 800, costoUnitario: 28, ventaPromedioMensual: 220, tendencia: 'stable', proveedor: 'Genérico Local', diasEntrega: 3 },
  { id: 38, nombre: 'Fósforos (10 cajas)', linea: 'Hogar', stock: 480, stockMin: 250, stockMax: 750, costoUnitario: 15, ventaPromedioMensual: 195, tendencia: 'down', proveedor: 'Genérico Local', diasEntrega: 3 },
  { id: 39, nombre: 'Cera para Piso 1L', linea: 'Hogar', stock: 320, stockMin: 180, stockMax: 500, costoUnitario: 48, ventaPromedioMensual: 145, tendencia: 'stable', proveedor: 'SC Johnson CA', diasEntrega: 5 },
  { id: 40, nombre: 'Insecticida 400ml', linea: 'Hogar', stock: 280, stockMin: 150, stockMax: 450, costoUnitario: 58, ventaPromedioMensual: 125, tendencia: 'up', proveedor: 'SC Johnson CA', diasEntrega: 5 },
  // Mascotas
  { id: 41, nombre: 'Croquetas Dog Chow 20kg', linea: 'Mascotas', stock: 180, stockMin: 80, stockMax: 300, costoUnitario: 285, ventaPromedioMensual: 75, tendencia: 'up', proveedor: 'Nestlé Purina Guatemala', diasEntrega: 6 },
  { id: 42, nombre: 'Arena para Gato 10kg', linea: 'Mascotas', stock: 220, stockMin: 100, stockMax: 350, costoUnitario: 95, ventaPromedioMensual: 85, tendencia: 'up', proveedor: 'Nestlé Purina Guatemala', diasEntrega: 6 },
  { id: 43, nombre: 'Snacks para Perro 500g', linea: 'Mascotas', stock: 320, stockMin: 150, stockMax: 500, costoUnitario: 65, ventaPromedioMensual: 145, tendencia: 'up', proveedor: 'Nestlé Purina Guatemala', diasEntrega: 6 },
  { id: 44, nombre: 'Croquetas Cat Chow 15kg', linea: 'Mascotas', stock: 150, stockMin: 70, stockMax: 250, costoUnitario: 245, ventaPromedioMensual: 65, tendencia: 'stable', proveedor: 'Nestlé Purina Guatemala', diasEntrega: 6 },
  { id: 45, nombre: 'Juguete Hueso de Goma', linea: 'Mascotas', stock: 180, stockMin: 80, stockMax: 300, costoUnitario: 45, ventaPromedioMensual: 75, tendencia: 'stable', proveedor: 'Genérico Importado', diasEntrega: 10 },
  { id: 46, nombre: 'Correa para Perro 2m', linea: 'Mascotas', stock: 120, stockMin: 60, stockMax: 200, costoUnitario: 85, ventaPromedioMensual: 45, tendencia: 'stable', proveedor: 'Genérico Importado', diasEntrega: 10 },
  { id: 47, nombre: 'Shampoo para Mascotas 500ml', linea: 'Mascotas', stock: 95, stockMin: 50, stockMax: 150, costoUnitario: 72, ventaPromedioMensual: 38, tendencia: 'up', proveedor: 'Hartz Guatemala', diasEntrega: 7 },
  { id: 48, nombre: 'Collar para Gato', linea: 'Mascotas', stock: 85, stockMin: 40, stockMax: 140, costoUnitario: 55, ventaPromedioMensual: 32, tendencia: 'stable', proveedor: 'Genérico Importado', diasEntrega: 10 },
];
